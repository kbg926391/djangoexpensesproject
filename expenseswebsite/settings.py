...
SECRET_KEY = 'django-insecure-qlb(d+h*(#%^665uv(3f%j&u(^98*s4d6^ex$kfu5owqg_uy5c'
...
EMAIL_USE_TLS = True
#DEFAUTL_FROM_EMAIL = os.environ.get('EMAIL_HOST_USER')
DEFAUTL_FROM_EMAIL = env.DEFAUTL_FROM_EMAIL
EMAIL_PORT = 587
